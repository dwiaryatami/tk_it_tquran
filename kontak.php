...
<div class="box-gmaps text-right">
<iframe src="<?= $d->google_maps ?>" width="500" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
