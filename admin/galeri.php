    ...
    <div class="content">
        <div class="container">
            <div class="box">
                ...
                <div class="box-body">
                    <a href="tambah-galeri.php" class="text-blue"><i class="fa fa-plus"></i> Tambah </a>
                    ...
                    <table class="table">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?= $p['keterangan'] ?></td>
                                    <td>
                                        <a href="edit-galeri.php?id=<?= $p['id'] ?>" title="Edit Data" class="text-green"><i class="fa fa-edit"></i></a>
