                    ...
                    <div class="box-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="keterangan" placeholder="Keterangan"  id="mytextarea" value="<?= $p->keterangan ?>"  class="input-control" required>
                            </div>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if($_FILES['gambar']['name'] != ''){
                                    ...
                                    if(!in_array($formatfile, $allowedtype)){
                                        echo '<div class="alert alert-error">Format file tidak di izinkan.</div>';
                                        return false;
